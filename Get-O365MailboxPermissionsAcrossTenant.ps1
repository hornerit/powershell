...
.NOTES
    ...
    Version History:
    --2020-02-10-Added check for Sid function to throw error if no results return, fixed mailbox identity for folder permissions to remove ":\"
